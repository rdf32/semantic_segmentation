...
def get_pretrain_dataset(pretrain_path, data_shape, batch_size, epochs):
...
def get_encoder():
    return unet_encoder(input_size=(256,256,3), n_filters=64, batch_norm=True, width=width)
...
pretrain_dataset, steps_per_epoch = get_pretrain_dataset(pretrain_images, [(256,256,3)], batch_size, epochs)


# Contrastive pretraining
pretraining_model = ContrastiveModel(temperature, width, **contrastive_augmentation)
...
pretraining_history = pretraining_model.fit(
    pretrain_dataset, epochs=epochs, steps_per_epoch=steps_per_epoch)
print(
