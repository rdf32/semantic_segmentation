...
def get_encoder():
    return tf.keras.Sequential(
        [   unet_encoder(input_size=(image_size, image_size, image_channels), n_filters=64, batch_norm=True)
...
if __name__ == '__main__':
    ...
    model = unet_encoder(input_size=(256, 256, 3), n_filters=64, batch_norm=True, width=width)
