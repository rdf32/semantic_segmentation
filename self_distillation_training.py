...
if __name__ == '__main__':
    ...
    def run_distillation(model_name, teacher, student, data_shape, batch_size, epochs, num_classes, paths):
        ...
        callbacks = [
            tf.keras.callbacks.ModelCheckpoint(model_output, monitor='loss', mode='min', save_best_only=True, save_weights_only=False)]
        ...
        data = {"loss": history.history['loss'], "iou": history.history['iou_score'], "val_loss": history.history['val_loss'], "val_iou": history.history['val_iou_score']}
